setTimeout(async function () {
  ...
  const webSocketUrls = 'wss://localhost:44300/Portfolio.Web/,ws://localhost:59651/Portfolio.Web/'.split(',');
  const sharedSecret = await getSecret('');
  let connection;
